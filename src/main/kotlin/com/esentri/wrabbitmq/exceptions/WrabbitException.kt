...
open class WrabbitException(message: String, throwable: Throwable? = null): RuntimeException(message, throwable) {
   companion object {
      fun generateBasicErrorMessage(sendingProperties: AMQP.BasicProperties) = "Exception while receiving reply to " +
